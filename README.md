...
| `tooltipHeader`        | `null`             | This text will be displayed in the tooltip header.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `tooltipText`          | `null`             | This text will be displayed in the tooltip body.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `tooltipSuggestions`   | `null`             | This array of strings will loop through below the tooltipText.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `tooltipPayload`       | `null`             | Payload sent to Rasa when the widget loads. The response will be displayed as a tooltip.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `iconSpinFrequence`    | `10000`            | The icon spinning frequence (in ms). A truly smaller value than 1000 will disable the spin animation. (default 10000)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `iconSpinNoTooltip`    | `true`             | Determines, if the icon will spin, when the tooltip is not displayed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `titleImage`           | `null`             | Image to display instead of title and subtitle. For raster images add enough whitespace on all sides, so that the image fits. For vector images adjust the viewBox attribute of the svg accordingly.                                                                                                                                                                                                                                                                                         
| `openLauncherImage`           | `null`             | Image to display on the launcher button                                                                                        
...
| `displayUnreadCount`   | `false`            | Show a counter with all unread messages if the widget is closed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
|`chatIndicator` | `false`  | display a colored dot the first time the chatbot-launcher is rendered, until the chatbot has been opened once    |
|`tooltipDisabled` | `false`  | disables the tooltip if set to true 
...
Text messages received when the widget is closed will be shown as a tooltip. If you wish to display a custom tooltip, use the `tooltipHeader`, `tooltipText` and/or `tooltipSuggestions` properties.
